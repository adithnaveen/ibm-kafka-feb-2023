...
## Agenda 
- Kafka Consumer 
- Send Multiple messages with Java to Kafka 
- Send Json (Serialize / Deserialize) - Show connecting (Mock) with DB 
- Process Large data into your system (Wikimedia)
- KRaft - Start Kafka Without Zookeeper
